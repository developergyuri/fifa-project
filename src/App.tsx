  ...
  return (
    <>
      ...
      >
        ...
        <GridItem rowSpan={1} colSpan={3} rounded="xl">
          <SimpleGrid
          ...
          >
                ...
                {selectedPlayer && (
                  <>
                    ...
                    <Stack spacing={4}>
                      ...
                      <Text fontSize="sm">
                        Tömeg: {playerData?.weight_kg} kg
                      </Text>
                      <Text fontSize="sm">
                        Magasság: {playerData?.height_cm} cm
                      </Text>
                      <Text fontSize="sm">
                        Láb: {playerData?.preferred_foot}
                      </Text>
                    </Stack>
                  </>
                )}
            ...
            <Box rounded="xl" bg="blackAlpha.400" gridArea="Stat" padding={4}>
              <Text>
